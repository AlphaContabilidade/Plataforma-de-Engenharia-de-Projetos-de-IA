...
idempotencia. Se o hash cobrisse apenas o texto, trocar o tipo de uma variavel
produziria o mesmo hash e o registry devolveria a versao antiga como se nada
tivesse mudado -- o contrato mudou, a versao tem de mudar.
"""
...
def test_assinatura_em_ordem_alfabetica():
